import {CONTROL_NAME_ZONE_NAME_TEXT, BLOCK_UNIQUE_CLASS_LABEL} from '../const';
...
export default {
    ...
    render() {
        ...
        this.jLabel = this.jElement.find("span[class=\"" + BLOCK_UNIQUE_CLASS_LABEL + "\"]");
    ...
    onChange(e) {
        ...
        this.jLabel.html(e.target.value || '');
        this.applyChanges();
    },
